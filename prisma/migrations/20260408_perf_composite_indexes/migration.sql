...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "ReminderLog_tenantId_sentAt_idx" ON "ReminderLog"("tenantId", "sentAt");

-- PaymentReminderLog: (tenantId, createdAt) for audit and retention queries
CREATE INDEX CONCURRENTLY IF NOT EXISTS "PaymentReminderLog_tenantId_sentAt_idx" ON "PaymentReminderLog"("tenantId", "sentAt");
