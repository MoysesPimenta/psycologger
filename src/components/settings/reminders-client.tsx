...
const TEMPLATE_META: Record<string, { label: string; description: string; defaultSubject: string; defaultBody: string }> = {
  CONFIRMATION: {
...
const TEMPLATE_TYPES = ["CONFIRMATION", "REMINDER_24H", "REMINDER_1H"] as const;
