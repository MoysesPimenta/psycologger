...
export default async function SADashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 dark:bg-gray-950 text-white dark:text-white p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Health widget */}
        <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 dark:border-gray-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-gray-400 dark:text-gray-400">{t("dashboard.clinics")}</p>
              <p className="text-2xl font-bold mt-1">{tenantCount}</p>
            </div>
            <div>
              <p className="text-gray-400 dark:text-gray-400">{t("dashboard.users")}</p>
              <p className="text-2xl font-bold mt-1">{userCount}</p>
            </div>
            <div>
              <p className="text-gray-400 dark:text-gray-400">{t("dashboard.patients")}</p>
              <p className="text-2xl font-bold mt-1">{patientCount}</p>
            </div>
            <div>
              <p className="text-gray-400 dark:text-gray-400">{t("dashboard.mrr")}</p>
              <p className="text-2xl font-bold mt-1">{formatCurrency(metrics.mrrCents)}</p>
            </div>
            <div>
              <p className="text-gray-400 dark:text-gray-400">{t("dashboard.activeSubscribers")}</p>
              <p className="text-2xl font-bold mt-1">{metrics.activeSubscribers}</p>
            </div>
            <div className={webhookErrors > 0 ? "text-red-400 dark:text-red-400" : ""}>
              <p className={webhookErrors > 0 ? "text-red-300 dark:text-red-300" : "text-gray-400 dark:text-gray-400"}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 dark:border-gray-800 rounded-xl p-5">
            <p className="text-gray-400 dark:text-gray-400 text-xs">{t("dashboard.clinics")}</p>
            <p className="text-4xl font-bold mt-1">{tenantCount}</p>
          </div>
          <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 dark:border-gray-800 rounded-xl p-5">
            <p className="text-gray-400 dark:text-gray-400 text-xs">{t("dashboard.users")}</p>
            <p className="text-4xl font-bold mt-1">{userCount}</p>
          </div>
        </div>

        {/* Recent tenants */}
        <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 dark:border-gray-800 rounded-xl">
          <div className="flex items-center justify-between p-5 border-b border-gray-800 dark:border-gray-800">
          ...
          <div className="divide-y divide-gray-800 dark:divide-gray-800">
            {recentTenants.map((tenant) => (
              <Link
                ...
                className="flex items-center justify-between p-4 hover:bg-gray-800/50 dark:hover:bg-gray-800/50 transition-colors group"
              >
                <div>
                ...
                <ArrowRight className="h-4 w-4 text-gray-600 dark:text-gray-600 group-hover:text-gray-300 dark:group-hover:text-gray-300" />
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 dark:border-gray-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <Link
              href="/sa/metrics"
              className="flex items-center gap-2 p-3 bg-gray-800/50 dark:bg-gray-800/50 hover:bg-gray-800 dark:hover:bg-gray-800 rounded transition-colors text-sm"
            >
